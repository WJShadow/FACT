...
def evaluation_jaccard(infer_masks, GT_masks, thresh_jacdist, gpu_num):
    ...
    if infer_masks.shape[0]>1000:
        ...
        Jdist_mat = fast_jaccard_cp(infer_masks, GT_masks, gpu_num)
...
def fast_jaccard_cp(masks1, masks2, gpu_num):
    '''
